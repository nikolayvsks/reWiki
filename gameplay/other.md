...
## Улучшенные вагонетки

На сервере включена экспериментальная функция «Улучшенное движение вагонеток», которая улучшает физику вагонеток и повышает их скорость (в 2,5 раза!). [Подробнее про это здесь](https://youtu.be/LIaRwjZiHHs?t=467).
